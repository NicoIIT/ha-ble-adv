...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            "fan_0: ['speed', 'on'] / {'speed': 1, 'on': True, 'dir': False, 'osc': False}",
        ),
        # FAN OFF
        (
            "agarce_v4",
            ...
            "fan_0: ['on'] / {'speed': 1, 'on': False, 'dir': True, 'osc': False}",
        ),
        # FAN DIR Reverse
        (
            "agarce_v4",
            ...
            "fan_0: ['dir'] / {'speed': 1, 'on': True, 'dir': False, 'osc': False}",
        ),
        # FAN OSC ON
        (
            "agarce_v4",
            ...
            "fan_0: ['osc'] / {'speed': 1, 'on': True, 'dir': True, 'osc': True}",
        ),
    ],
)
