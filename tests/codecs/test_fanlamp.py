...
class TestMultiEncoderFanlampV0R0(_TestMultiEncoderBase):
...
class TestMultiEncoderFanlampV0R1(_TestMultiEncoderBase):
    """FanlampV0 / R1 Multi Encoder tests."""
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "fanlamp_pro_v1/r0",
            "0201191BFFF0FFB65F2B5E00FC3151787E990824CA3BFCB1A3F455E8CFFAD6",
            "cmd: 0x05, param: 0x00, args: [0,0,128]",
            "id: 0x00008023, index: 0, tx: 0, seed: 0x0000",
            "light_0: ['cmd'] / {'sub_type': 'cww', 'cmd': 'B-', 'step': 0.1}",
        ),
        # BR+
        (
            "fanlamp_pro_v1/r0",
            "0201191BFFF0FFB65F2B5E00FC3151F87E990824CA3BFCD1A3F455E8CF95D7",
            "cmd: 0x04, param: 0x00, args: [0,0,128]",
            "id: 0x00008023, index: 0, tx: 0, seed: 0x0000",
            "light_0: ['cmd'] / {'sub_type': 'cww', 'cmd': 'B+', 'step': 0.1}",
        ),
        # K+
        (
            "fanlamp_pro_v1/r0",
            "0201191BFFF0FFB65F2B5E00FC3151B87E990824CA3BFCD1A3F45528CF505E",
            "cmd: 0x06, param: 0x00, args: [0,0,128]",
            "id: 0x00008023, index: 0, tx: 0, seed: 0x0000",
            "light_0: ['cmd'] / {'sub_type': 'cww', 'cmd': 'K+', 'step': 0.1}",
        ),
        # K-
        (
            "fanlamp_pro_v1/r0",
            "0201191BFFF0FFB65F2B5E00FC3151387E990824CABBFC7067F455E84F40BF",
            "cmd: 0x07, param: 0x00, args: [0,0,128]",
            "id: 0x00008023, index: 0, tx: 0, seed: 0x0000",
            "light_0: ['cmd'] / {'sub_type': 'cww', 'cmd': 'K-', 'step': 0.1}",
        ),
