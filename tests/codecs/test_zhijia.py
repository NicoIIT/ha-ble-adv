...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            [],
            "fl",
            "02011A1BFF229DB62429CB3CF8F45B33E24981117DEC64F64A5F85F69CA919",
            "cmd: 0xA8, param: 0x00, args: [25,0,0]",
            "id: 0x00123456, index: 0, tx: 16, seed: 0x0000",
            "light_0: ['cold', 'warm'] / {'sub_type': 'cww', 'cold': 0.1, 'warm': 0.0}",
        ),
        # WARN 100%
        (
            "zhijia_v2",
            [],
            "fl",
            "02011A1BFF229D55C2D328DA020EA1CC18B37BEB9B139E0C4A5F85F69CA919",
            "cmd: 0xA8, param: 0x00, args: [0,25,0]",
            "id: 0x00123456, index: 0, tx: 12, seed: 0x0000",
            "light_0: ['cold', 'warm'] / {'sub_type': 'cww', 'cold': 0.0, 'warm': 0.1}",
        ),
        # BR 10%
        (
            "zhijia_v2",
            [],
            "fl",
            "02011A1BFF229D56DBC92EC61814BBCC02A961F1871384164A5F85F69CA919",
            "cmd: 0xA8, param: 0x00, args: [25,5,0]",
            "id: 0x00123456, index: 0, tx: 10, seed: 0x0000",
            "light_0: ['cold', 'warm'] / {'sub_type': 'cww', 'cold': 0.1, 'warm': 0.02}",
        ),
    ],
)
class TestEncoderZhijiaFullAll(_TestEncoderFullAll):
    """Zhi Jia Encoder / Decoder Full ALL tests."""
