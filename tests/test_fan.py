...
async def test_fan_base(device: _Device) -> None:
    ...
    fan: BleAdvFan = create_entity({CONF_TYPE: FAN_TYPE_3SPEED}, device, 0)
    ...
    assert fan.get_attrs() == {ATTR_ON: False, ATTR_SUB_TYPE: FAN_TYPE_3SPEED, ATTR_DIR: True, ATTR_OSC: False, ATTR_PRESET: None, ATTR_SPEED: 3}
    await fan.async_set_percentage(33)
    assert fan.percentage == 33
    assert fan.is_on
    assert fan.get_attrs() == {ATTR_ON: True, ATTR_SUB_TYPE: FAN_TYPE_3SPEED, ATTR_DIR: True, ATTR_OSC: False, ATTR_PRESET: None, ATTR_SPEED: 1}
    ...
    assert fan.get_attrs() == {ATTR_ON: False, ATTR_SUB_TYPE: FAN_TYPE_3SPEED, ATTR_DIR: True, ATTR_OSC: False, ATTR_PRESET: None, ATTR_SPEED: 1}
    ...
    assert fan.get_attrs() == {ATTR_ON: True, ATTR_SUB_TYPE: FAN_TYPE_3SPEED, ATTR_DIR: True, ATTR_OSC: False, ATTR_PRESET: None, ATTR_SPEED: 2}
    device.assert_apply_change(fan, [ATTR_SPEED])
    await fan.async_turn_off()
    assert fan.percentage == 66
    assert fan.get_attrs() == {ATTR_ON: False, ATTR_SUB_TYPE: FAN_TYPE_3SPEED, ATTR_DIR: True, ATTR_OSC: False, ATTR_PRESET: None, ATTR_SPEED: 2}
    device.assert_apply_change(fan, [ATTR_ON])
    ...
    assert fan.is_on
    fan.apply_attrs(BleAdvEntAttr([ATTR_SPEED], {ATTR_ON: True, ATTR_SUB_TYPE: FAN_TYPE_3SPEED, ATTR_SPEED: 3}, FAN_TYPE, 0))
    assert fan.percentage == 100
    fan.apply_attrs(BleAdvEntAttr([ATTR_SPEED], {ATTR_ON: True, ATTR_SUB_TYPE: FAN_TYPE_6SPEED, ATTR_SPEED: 3}, FAN_TYPE, 0))
    assert fan.percentage == 50


async def test_fan_dir(device: _Device) -> None:
    """Test fan direction."""
    fan: BleAdvFan = create_entity({CONF_TYPE: FAN_TYPE_3SPEED, CONF_USE_DIR: True, CONF_REFRESH_DIR_ON_START: False}, device, 1)
    ...
    assert fan.is_on
    assert fan.get_attrs() == {ATTR_ON: True, ATTR_SUB_TYPE: FAN_TYPE_3SPEED, ATTR_DIR: False, ATTR_OSC: False, ATTR_PRESET: None, ATTR_SPEED: 3}
...
async def test_fan_dir_on_switch_on(device: _Device) -> None:
    ...
    fan: BleAdvFan = create_entity({CONF_TYPE: FAN_TYPE_3SPEED, CONF_USE_DIR: True, CONF_REFRESH_DIR_ON_START: True}, device, 1)
    assert fan.id == (FAN_TYPE, 1)
    assert fan.supported_features == BASE_FAN_FEATURES | FanEntityFeature.DIRECTION
    ...
    await fan.async_turn_on()
    assert fan.is_on
    assert fan.get_attrs() == {ATTR_ON: True, ATTR_SUB_TYPE: FAN_TYPE_3SPEED, ATTR_DIR: True, ATTR_OSC: False, ATTR_PRESET: None, ATTR_SPEED: 3}
    device.assert_apply_change(fan, [ATTR_ON, ATTR_DIR])


async def test_fan_osc(device: _Device) -> None:
    """Test fan oscillating."""
    fan: BleAdvFan = create_entity({CONF_TYPE: FAN_TYPE_3SPEED, CONF_USE_OSC: True, CONF_REFRESH_OSC_ON_START: False}, device, 2)
    ...
    assert fan.is_on
    assert fan.get_attrs() == {ATTR_ON: True, ATTR_SUB_TYPE: FAN_TYPE_3SPEED, ATTR_DIR: True, ATTR_OSC: True, ATTR_PRESET: None, ATTR_SPEED: 3}
...
async def test_fan_osc_on_switch_on(device: _Device) -> None:
    ...
    fan: BleAdvFan = create_entity({CONF_TYPE: FAN_TYPE_3SPEED, CONF_USE_OSC: True, CONF_REFRESH_OSC_ON_START: True}, device, 2)
    assert fan.id == (FAN_TYPE, 2)
    assert fan.supported_features == BASE_FAN_FEATURES | FanEntityFeature.OSCILLATE
...
async def test_fan_preset(device: _Device) -> None:
    """Test fan presets."""
    fan: BleAdvFan = create_entity({CONF_TYPE: FAN_TYPE_6SPEED, CONF_PRESETS: ["PRES1", "PRES2"]}, device, 3)
    ...
    assert fan.percentage == 100
    assert fan.get_attrs() == {ATTR_ON: False, ATTR_SUB_TYPE: FAN_TYPE_6SPEED, ATTR_DIR: True, ATTR_OSC: False, ATTR_PRESET: None, ATTR_SPEED: 6}
    await fan.async_set_preset_mode("PRES1")
    assert fan.preset_mode == "PRES1"
    assert fan.is_on
    assert fan.get_attrs() == {ATTR_ON: True, ATTR_SUB_TYPE: FAN_TYPE_6SPEED, ATTR_DIR: True, ATTR_OSC: False, ATTR_PRESET: "PRES1", ATTR_SPEED: 0}
    device.assert_apply_change(fan, [ATTR_ON, ATTR_PRESET])
    await fan.async_set_preset_mode("PRES1")
    device.assert_no_change()
    await fan.async_turn_off()
    assert not fan.is_on
    assert fan.get_attrs() == {ATTR_ON: False, ATTR_SUB_TYPE: FAN_TYPE_6SPEED, ATTR_DIR: True, ATTR_OSC: False, ATTR_PRESET: "PRES1", ATTR_SPEED: 0}
    device.assert_apply_change(fan, [ATTR_ON])
    await fan.async_turn_on()
    assert fan.is_on
    assert fan.get_attrs() == {ATTR_ON: True, ATTR_SUB_TYPE: FAN_TYPE_6SPEED, ATTR_DIR: True, ATTR_OSC: False, ATTR_PRESET: "PRES1", ATTR_SPEED: 0}
    ...
    assert fan.is_on
    assert fan.get_attrs() == {ATTR_ON: True, ATTR_SUB_TYPE: FAN_TYPE_6SPEED, ATTR_DIR: True, ATTR_OSC: False, ATTR_PRESET: None, ATTR_SPEED: 3}
    device.assert_apply_change(fan, [ATTR_SPEED])
    await fan.async_turn_on(preset_mode="PRES2")
    assert fan.is_on
    assert fan.get_attrs() == {ATTR_ON: True, ATTR_SUB_TYPE: FAN_TYPE_6SPEED, ATTR_DIR: True, ATTR_OSC: False, ATTR_PRESET: "PRES2", ATTR_SPEED: 0}
