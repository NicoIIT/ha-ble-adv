...
FLCODECS = [
    ...
    FanLampEncoderV2(0x0400).id("fanlamp_pro_v2").ble(0x19, 0x03).add_translators(TRANS_FANLAMP_V2),
    # FanLamp remotes
...
LSCODECS = [
    ...
    FanLampEncoderV2(0x0100).id("lampsmart_pro_v2").ble(0x19, 0x03).add_translators(TRANS_FANLAMP_V2),
    # LampSmart remotes
